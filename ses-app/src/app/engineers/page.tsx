        ...
        <div className="grid grid-cols-1 gap-6">
          {engineers.map((e) => (
            <Link
              key={e.id}
              href={`/engineers/${e.id}`}
              className="w-full block bg-card border border-base rounded-xl shadow-md p-6 flex flex-col gap-3 hover:shadow-xl transition-shadow cursor-pointer focus:outline-accent"
            >
